...
const generateMockData = (days: number) => {
  ...
  for (let i = days - 1; i >= 0; i--) {
    ...
    const hours =
      Math.round(avgDailyHours * (0.75 + Math.random() * 0.5) * 10) / 10;
  ...
  const baseData = [
    {
      ...
      cases: Math.round(days * 1.2),
    },
    {
      name: "Bob Smith",
      image: "/avatars/bob.jpg",
      cases: Math.round(days * 0.9),
    },
    {
      name: "Carol Davis",
      image: "/avatars/carol.jpg",
      cases: Math.round(days * 1.1),
    },
    {
      name: "David Wilson",
      image: "/avatars/david.jpg",
      cases: Math.round(days * 0.8),
    },
  ];
...
const PerformanceMetricsCard = () => {
  ...
  const data = useMemo(
    () => generateMockData(selectedFilter.days),
    [selectedFilter.days]
  );
  const technicianData = useMemo(
    () => generateTechnicianData(selectedFilter.days),
    [selectedFilter.days]
  );
