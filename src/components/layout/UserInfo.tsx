          ...
          <div className="py-3 px-4 border-b">
            <div style={{ display: "flex", flexDirection: "row" }}>
              ...
              <div>
                ...
                <p className="text-m text-black-500  mb-1 block">
                  {data?.role}
                </p>
              </div>
            </div>
          ...
          <div className="py-1">
            {menuItems.map((item, index) => (
              <button
                ...
                className={
                  item.label == "Profile"
                    ? "zflex items-center w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 focus:outline-nonedd py-3 px-4 border-b"
                    : "zflex items-center w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 focus:outline-nonedd"
                }
              >
                {item.icon}
