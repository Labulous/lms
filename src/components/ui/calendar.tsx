  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption: "relative flex w-full justify-between items-center",
        caption_label: "text-sm font-medium grow text-center",
        nav: "!relative !static flex space-x-1 items-center",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "!static !relative h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100"
        ),
        nav_button_previous: "!static !relative",
        nav_button_next: "!static !relative",
