...
const AdjustmentReceiptPreviewModal: React.FC<InvoicePreviewModalProps> = ({
  isOpen,
  onClose,
  formData,
  caseDetails,
  ...
  console.log('Adjustment data....................', caseDetails)
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      pdf.save(`AdjustmentReceipt-${caseDetails[0]?.id || "undefined"}.pdf`);
          ...
          <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  onClick={() => handlePrint("adjustment_receipt")}
                  disabled={isPrinting}
                  className="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50"
                >
...
export default AdjustmentReceiptPreviewModal;
