...
import { createUserByAdmins, getCurrentUser, getLabIdByUserId, signUp } from "@/services/authService";
                            ...
                            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                                ...
                                <DialogContent style={{
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                                    ...
                                                    <SelectContent>
                                                        {user?.role == "admin" &&
                                                            roles.admin.map((item, index) => {
                                                                return <SelectItem key={index} value={item.role}>{item.label}</SelectItem>
                                                            })
                                                        }
                                        ...
                                        {!editingUser && <div className="grid grid-cols-2 gap-2">
                                            <div className="space-y-2">
                                        ...
                                        {
                                            formData.role == "client" && <div className="grid grid-cols-2 gap-2">
                                                <div className="space-y-2">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <Input
                                                        ...
                                                        onChange={(e) =>
                                                            setFormData((prev) => ({ ...prev, clinicRegistrationNumber: e.target.value }))
                                                        }
                                        ...
                                        <DialogFooter>
                                            <Button type="submit" disabled={loading}>
                                                {editingUser ? loading ? "Updating User" : "Update User" : loading ? "Creating User" : "Create User"}
                                            </Button>
                                        </DialogFooter>
