  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold">Working Pans</h2>
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>
                {editingTag ? "Edit Pan" : "Create New Pan"}
              </DialogTitle>
            </DialogHeader>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <DialogFooter>
                <Button type="submit" disabled={loading}>
                  {editingTag ? loading ? "Updating Pan" :  "Update Pan" : loading ? "Creating tag" : "Create Pan"}
                </Button>
              </DialogFooter>
            </form>
          </DialogContent>
...
export default WorkingPansSettings;
